...
public class PPLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pplactivity);
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                if (isWithinOpeningPeriod || isWeekend) {
                    ...
                    Toast.makeText(PPLActivity.this, "Date en dehors des créneaux", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (heureDebut == 7 || heureFin == 8 ) {
                    Toast.makeText(PPLActivity.this, "Veuillez sélectionner une heure valide", Toast.LENGTH_SHORT).show();
                    return;
                }


                if (heureFin - heureDebut < 1) {
                    Toast.makeText(PPLActivity.this, "La durée de la réservation doit être d'au moins 1 heure", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (selectedDate == null) {
                    Toast.makeText(PPLActivity.this, "Veuillez sélectionner une date", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void checkAndSaveDate() {
        ...
        ulmRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (isDateReserved) {
                    Toast.makeText(PPLActivity.this, "Un créneaux est déjà réservé de " + reservedHeureDebut + "h à " + reservedHeureFin + "h.", Toast.LENGTH_SHORT).show();
                } else {
                    saveData();
                    saveDate();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PPLActivity.this, "Erreur lors de la vérification des dates", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        DatabaseReference titleRef = FirebaseDatabase.getInstance().getReference("AeroClubUser").child(noeud + "/" + "date_PPL");
        ...
        reservationRef.updateChildren(updateData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(PPLActivity.this, "Erreur lors de l'enregistrement", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void updateTotalHours(int duration) {
        ...
        if (totalHoursRegistered >= 45) {
            Toast.makeText(PPLActivity.this, "Total de 45 heures atteint.", Toast.LENGTH_SHORT).show();
            finish();
        } else {
            int remainingHours = 45 - totalHoursRegistered;
            Toast.makeText(PPLActivity.this, "Enregistré ! Il vous reste encore " + remainingHours + " heures pour atteindre 45 heures.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void saveDate() {
        ...
        reservationRef.updateChildren(reservationData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(PPLActivity.this, "Enregistré !", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PPLActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
