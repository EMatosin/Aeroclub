...
public class LAPLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laplactivity);
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                if (isWithinOpeningPeriod || isWeekend) {
                    ...
                    Toast.makeText(LAPLActivity.this, "Date en dehors des créneaux", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (heureDebut == 7 || heureFin == 8 ) {
                    Toast.makeText(LAPLActivity.this, "Veuillez sélectionner une heure valide", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (heureFin - heureDebut < 1) {
                    Toast.makeText(LAPLActivity.this, "La durée de la réservation doit être d'au moins 1 heure", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (selectedDate == null) {
                    Toast.makeText(LAPLActivity.this, "Veuillez sélectionner une date", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void checkAndSaveDate() {
        DatabaseReference ulmRef = FirebaseDatabase.getInstance().getReference("DatesChoisisULM/piper");
        ...
        ulmRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (isDateReserved) {
                    Toast.makeText(LAPLActivity.this, "Un créneaux est déjà réservé de " + reservedHeureDebut + "h à " + reservedHeureFin + "h.", Toast.LENGTH_SHORT).show();
                } else {
                    saveData();
                    saveDate();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(LAPLActivity.this, "Erreur lors de la vérification des dates", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        DatabaseReference titleRef = FirebaseDatabase.getInstance().getReference("AeroClubUser").child(noeud + "/" + "date_LAPL");
        ...
        reservationRef.updateChildren(updateData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LAPLActivity.this, "Erreur lors de l'enregistrement", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void updateTotalHours(int duration) {
        ...
        if (totalHoursRegistered >= 30) {
            Toast.makeText(LAPLActivity.this, "Total de 30 heures atteint.", Toast.LENGTH_SHORT).show();
            finish();
        } else {
            int remainingHours = 30 - totalHoursRegistered;
            Toast.makeText(LAPLActivity.this, "Enregistré ! Il vous reste encore " + remainingHours + " heures pour atteindre 30 heures.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void saveDate() {
        ...
        DatabaseReference ulmRef = FirebaseDatabase.getInstance().getReference("DatesChoisisULM/piper/" + noeud);
        ...
        reservationRef.updateChildren(reservationData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(LAPLActivity.this, "Enregistré !", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(LAPLActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
